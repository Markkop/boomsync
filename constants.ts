...
export const TIMER_COLORS = {
  ...
  [TimerStatus.READY_TO_BOOM]: 'bg-orange-500 border-orange-400 text-zinc-900'
};
...
export const EXPLOSION_SOUND_URL = 'https://actions.google.com/sounds/v1/weapons/big_explosion_cut_off.ogg';
