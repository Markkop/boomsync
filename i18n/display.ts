...
export function resolveKeywordKey(keyword: string): string | undefined {
  ...
  const partials: Array<[string, string[]]> = [
    ['card share power', ['card share power', 'poder de compartilhar carta', 'poder de compartir carta']],
    ['color share power', ['color share power', 'poder de compartilhar cor', 'poder de compartir color']],
    ['private reveal power', ['private reveal power', 'poder de revelação privada', 'poder de revelación privada']],
    ['public reveal power', ['public reveal power', 'poder de revelação pública', 'poder de revelación pública']],
