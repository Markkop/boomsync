...
export const KEYWORD_GLOSSARY: Record<string, KeywordEntry> = {
  ...
  'card share power': {
    label: { en: 'card share power', pt: 'poder de compartilhar carta', es: 'poder de compartir carta' },
    definition: {
  ...
  'color share power': {
    label: { en: 'color share power', pt: 'poder de compartilhar cor', es: 'poder de compartir color' },
    definition: {
  ...
  'private reveal power': {
    label: { en: 'private reveal power', pt: 'poder de revelação privada', es: 'poder de revelación privada' },
    definition: {
  ...
  'public reveal power': {
    label: { en: 'public reveal power', pt: 'poder de revelação pública', es: 'poder de revelación pública' },
    definition: {
